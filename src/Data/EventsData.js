const EventsData = [
...

  {
    ...
    EventBanner:
      "https://images.pexels.com/photos/7008010/pexels-photo-7008010.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    Description:
      "Each team will be assigned 2 PCs and the team can divide the tasks  within themselves.Every PC will have 5 questions for the first round. The questions will be interlinked with each other. Solving the questions on PC 1 will unlock the questions on PC 2. After the last question will be solved, the outputs will be concatenated to get the key for the next round. First 7 teams to finish the first round will be qualified for the second round. Round 2 is similar but the difficulty level will be raised." ,
    EventHost: "",
    Date: "20-02-2023",
    DateWord: "Mon, Feb 20",
    Time: "",
    Location: "B Building Labs",
    Dept: "CS",
    EntryFee: "",
  },
